...
df_2022 = pd.read_csv('/Users/samwirth/Desktop/643/stuff_plus/stufff_plus/2022_bb_data.csv')
df_2023 = pd.read_csv('/Users/samwirth/Desktop/643/stuff_plus/stufff_plus/2023_bb_data.csv')
...
# model = CatBoostRegressor(learning_rate=.05, max_depth=6, iterations=511, loss_function='RMSE', eval_metric='RMSE', verbose=False)
...
# pd.Series(ypred).to_csv('/Users/samwirth/Desktop/643/stuff_plus/stufff_plus/bb_pred_ssw.csv', index=False)

# model_path = "/Users/samwirth/Desktop/643/stuff_plus/stufff_plus/bb_catboost_model.cbm"
...
# # # {'cat_features': array([8]), 'iterations': 511, 'learning_rate': 0.05, 'loss_function': 'RMSE', 'max_depth': 6}